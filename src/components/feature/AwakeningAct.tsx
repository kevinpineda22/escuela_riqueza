    ...
    <div aria-label="El despertar">
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center px-6 py-20">
        <motion.h2
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white/55 leading-[1.1] tracking-tight max-w-5xl text-center text-balance"
        >
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center px-6 py-20">
        <motion.h2
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.9, ease: "easeOut" }}
          className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold leading-[1.2] tracking-tight max-w-5xl text-center text-balance pb-3"
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60">
            Es momento de
          </span>{" "}
          <span className="text-gold italic drop-shadow-[0_0_30px_rgba(204,164,59,0.5)] pr-5 box-decoration-clone">
            cambiar.
          </span>
        </motion.h2>
      </section>
      ...
      {/* Frame 3 — Los números */}
      <section className="relative min-h-[100svh] flex items-center justify-center px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 lg:gap-24 w-full max-w-5xl">
