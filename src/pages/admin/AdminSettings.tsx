...
const AdminSettings = () => {
  return (
    ...
    >
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-4 tracking-tight">Ajustes del Sistema</h1>
      <p className="text-textMuted text-lg max-w-md mb-8">
        Configura integraciones de Stripe, Cloudflare, correos transaccionales y reglas de negocio.
      </p>
