...
const AdminUsers = () => {
  return (
    ...
    >
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-4 tracking-tight">Gestión de Usuarios</h1>
      <p className="text-textMuted text-lg max-w-md mb-8">
        Administra suscripciones, asigna roles especiales y brinda soporte directo a los alumnos.
      </p>
