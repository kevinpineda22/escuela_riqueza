...
const AdminContentManager = () => {
  return (
    ...
    >
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-4 tracking-tight">Gestor de Contenido</h1>
      <p className="text-textMuted text-lg max-w-md mb-8">
        Organiza módulos, edita información de clases publicadas y gestiona los recursos descargables.
      </p>
