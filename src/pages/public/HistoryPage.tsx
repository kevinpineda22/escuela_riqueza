          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold via-amber-100 to-goldHover italic">
              <EditableField
                as="span"
                className="inline"
                textKey="history_title_accent"
                defaultValue="cambiar tu vida?"
              />
            </span>
          </h1>
              ...
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 flex items-center gap-3">
                  ...
                  <EditableField
                    ...
                    defaultValue="¿Quién fundó La Escuela de la Riqueza?"
                  />
                </h2>
                <EditableField
                  as="p"
                  textKey="history_founder_1"
                  defaultValue="Es un programa único en su genero, radicalmente innovador en sus contenidos, creado por Iván Mazo Mejía hace 15 años, consultor y asesor empresarial desde hace 27 años en varios países de América y con experiencia en todo tipo de industrias."
                  multiline
                />
                <EditableField
                  as="p"
                  textKey="history_founder_2"
                  defaultValue="Dicha experiencia me permite plantear este rediseño cerebral en función de entregarle al mundo un nuevo modelo de empresario que potencia su inteligencia de una manera más integradora, más creadora, y sobre todo más comprometida con la nueva competitividad mundial."
                  multiline
                />
                <EditableField
                  as="p"
                  textKey="history_founder_3"
                  defaultValue="La Escuela de la Riqueza enseña al empresario a ver de una forma totalmente diferente la realidad que vive, lo dota de conceptos que le generan grandes transformaciones mentales de tal manera que al terminar el ciclo ya no vuelve a ser el mismo que llegó."
                  multiline
                />
              </div>
              ...
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 flex items-center gap-3">
                  ...
                  <EditableField
                    ...
                    defaultValue="Para quién es la Escuela de la Riqueza"
                  />
                </h2>
                <EditableField
                  as="p"
                  textKey="history_audience_1"
                  before={
                    <>
                      <strong>Escuela de la Riqueza:</strong>{" "}
                    </>
                  }
                  defaultValue="es un innovador programa de formación para empresarios que se toman la vida con carácter y poder. Aunque usted tenga una empresa es posible que su vida no sea la de un empresario, eso ocurre demasiado y es uno de los aspectos que más bloquea la riqueza."
                  multiline
                />
                <EditableField
                  as="p"
                  textKey="history_audience_2"
                  defaultValue="Escuela de la Riqueza acoge a jóvenes que están soñando su vida como empresarios. Nuestro revolucionario programa despierta el genio creador que cada joven lleva dentro."
                  multiline
                />
                <EditableField
                  as="p"
                  textKey="history_audience_3"
                  defaultValue="Por la Escuela de la Riqueza pasan profesionales de todas las disciplinas que se ven enfrentadas a la realidad de formar empresa y no saben qué pasos dar, cómo se pueden proyectar, hacia donde deben dirigir sus esfuerzos, en qué se deben centrar sus acciones de cada día."
                  multiline
                />
              </div>
            </div>
