...
const LandingPage = () => {
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-darker selection:bg-gold/30 font-sans text-textMain">
      ...
      <section
        id="historia"
        className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-16 px-6 pt-24 pb-20 max-w-7xl mx-auto min-h-[90vh]"
      >
      ...
      <section id="modulos" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5">
        <div className="text-center mb-16">
          ...
          <p className="text-textMuted max-w-xl mx-auto text-lg">
            Seis inteligencias críticas para escalar tu capacidad y transformar tu visión, con clases gratuitas llenas
            de valor.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modulos.map((modulo) => (
            <Link
              key={modulo.id}
              to="/leccion"
              className="block group p-8 rounded-3xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-md hover:bg-white/[0.05] hover:border-gold/30 transition-all duration-300"
            >
              ...
              <p className="text-textMuted leading-relaxed">
                Lecciones pre-grabadas en formato masterclass para potenciar esta área vital de forma directa y al
                grano.
              </p>
